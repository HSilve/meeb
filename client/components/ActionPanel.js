        ...
        {!this.props.whiteboard.closed &&
          <div className="fixed-action-btn" style={{ bottom: '45px', right: '24px' }} >
            ...
            <span>
              ...
              <form id="actionForm" onSubmit={(evt) => { evt.preventDefault(); this.props.handleSubmit(evt, this.state.file, this.state.name, this.state.type, this.props.user.id, this.props.match.params.id, this.props.notes.length) }} style={{ bottom: '90px', right: '100px', position: 'fixed' }}>
